    ...
    return Column(
      children: [
          ...
          children: [
            ...
            TextButton.icon(
              onPressed: () async {
                ...
                String picName =
                    "PiliPalaR_loginQRCode_${DateTime.now().toString().replaceAll(' ', '_').replaceAll(':', '-').split('.').first}";
                final SaveResult result = await SaverGallery.saveImage(
                  Uint8List.fromList(pngBytes),
                  name: picName,
                  fileExtension: 'png',
                  // 保存到 PiliPalaR文件夹
                  androidRelativePath: "Pictures/PiliPalaR",
        ...
        Padding(
            ...
            child: Text('请务必在 PiliPalaR 开源仓库等可信渠道下载安装。',
                style: Theme.of(context).textTheme.labelSmall!.copyWith(
                    color: Theme.of(context)
                        .colorScheme
                        .onSurface
